...
class TestParamDefinitions:
    ...
    def test_all_params_have_required_fields(self):
        """All parameters have min, max, default, step, category."""
    ...
    def test_defaults_within_limits(self):
        """All default values are within min/max limits."""
        for name, defn in PARAM_DEFINITIONS.items():
...
class TestDefaultParams:
    """Tests for default parameters dictionary."""
    
    def test_all_params_have_defaults(self):
        """All defined parameters have a default value."""
...
class TestParamCategories:
    """Tests for parameter category groupings."""
    
    def test_primary_params_exist(self):
        """Primary parameters are defined."""
        assert 'num_boids' in PRIMARY_PARAMS
        assert 'visual_range' in PRIMARY_PARAMS
        assert 'separation_strength' in PRIMARY_PARAMS
    
    def test_predator_params_exist(self):
        """Predator parameters are defined."""
    ...
    def test_get_params_by_category(self):
        """get_params_by_category returns correct params."""
...
class TestPresets:
    ...
    def test_preset_names_defined(self):
    ...
    def test_valid_presets_list(self):
        """VALID_PRESETS contains all preset names."""
    ...
    def test_preset_count(self):
        """Correct number of presets defined."""
